...
const Footer = () => {
  return (
    <footer className="text-white font-[Quicksand]">
      {/* ── MAIN FOOTER ── */}
      <div
        className="bg-cover bg-center bg-no-repeat pt-14 pb-14"
      ...
      >
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          {/* COL 1 — Company */}
          <div>
            <h3 className="font-semibold text-white text-[19px] mb-5 font-[Quicksand]">
              Company
            </h3>
            <ul className="space-y-2.5 text-[14px] text-gray-300 font-[Quicksand]">
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-[13px] sm:text-[14px] text-gray-300 font-[Quicksand]">
          ...
          <div>
            ...
            <ul className="space-y-4 text-[14px] text-gray-300 font-[Quicksand]">
              {/* Phone */}
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 mt-0.5 shrink-0 text-white" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="break-all">support@desaiinvestment.in</span>
              </li>
          ...
          <div className="flex flex-col items-start">
            ...
            <div className="mb-6">
              <Link to="/">
                <img src="/Logo.png" alt="Blue Sage Wealth" className="h-14 w-auto object-contain" />
              </Link>
            </div>

            {/* Follow Us Heading */}
            <h3 className="font-semibold text-white text-[19px] mb-4 font-[Quicksand]">
              Follow Us
            </h3>

            {/* Dark Uniform Social Media Icon Buttons */}
            <div className="flex items-center gap-2 flex-wrap">
              {/* Facebook */}
              <a
                href="https://www.facebook.com/people/Blue-Sage-Wealth/61582673409613/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="w-9 h-9 rounded-lg bg-[#242424] border border-gray-700/80 flex items-center justify-center text-gray-300 hover:bg-white hover:text-black transition-all duration-200"
              >
              ...
              {/* X / Twitter */}
              <a
                href="https://x.com/SageBlue55139"
                target="_blank"
                rel="noopener noreferrer"
              ...
              {/* Pinterest */}
              <a
                href="https://www.pinterest.com/bluesagewealth/_profile/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              {/* LinkedIn */}
              <a
                href="https://www.linkedin.com/company/blue-sage-wealth/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="w-9 h-9 rounded-lg bg-[#242424] border border-gray-700/80 flex items-center justify-center text-gray-300 hover:bg-white hover:text-black transition-all duration-200"
              ...
              {/* YouTube */}
              <a
                href="https://www.youtube.com/@BlueSageWealth"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="YouTube"
                className="w-9 h-9 rounded-lg bg-[#242424] border border-gray-700/80 flex items-center justify-center text-gray-300 hover:bg-white hover:text-black transition-all duration-200"
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/bluesagewealth/"
                target="_blank"
                rel="noopener noreferrer"
      ...
      {/* ── BOTTOM BAR ── */}
      <div className="bg-[#0a0a0a] border-t border-[#222222] py-6 px-4">
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center gap-4 font-[Quicksand]">
          {/* Risk Factors Disclaimer */}
          <p className="text-[12px] sm:text-[13px] text-[#B0B0B0] leading-relaxed max-w-6xl mx-auto">
            <span className="text-white font-bold">Risk Factors – </span>
          ...
          <p className="text-[12px] sm:text-[13px] text-[#909090]">
            AMFI Registered Mutual Fund Distributor | ARN- 152121 | ARN valid from: 14 Aug 2018 | Current Validity of ARN: 13 Aug 2027
          </p>

          <div className="flex flex-wrap justify-center items-center gap-x-2 gap-y-1 text-[12px] text-[#909090]">
