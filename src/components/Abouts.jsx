...
> 
  ...
  <circle r="5" fill="#a855f7">
        ...
        <div className="max-w-7xl  mx-auto px-6 text-center">
          {/* Heading */}
                 <div className="max-w-7xl  mx-auto px-6 bg-gradient-to-b from-[#0b0b0b] via-[#000000] to-[#050505] rounded-3xl py-10">
                   ...
                   <h2 className="text-center text-[80px] font-semibold font-[Quicksand] font-weight-600 text-gray-300">
                     AWARDS & RECOGNITIONS

                   </h2>
                   <p className="mb-16 text-[20px] font-semibold font-[Quicksand] font-weight-600 text-gray-300 ">Recognized by leading mutual fund houses and industry platforms:</p>
    ...
    >
      {team.map((item, index) => (
        <SwiperSlide key={index}>
          <div className="w-[265px] mx-auto bg-white rounded-[28px] overflow-hidden transition duration-300 hover:scale-105">
    ...
    {/* Bottom Text */}
    <p className="text-center font-weight-400 text-white text-[28px] mt-12 max-w-5xl mx-auto leading-[1.4] font-light">
      Our team supports clients with investment facilitation,
      portfolio tracking, and ongoing service assistance.
    </p>
          </div>
        </section>
