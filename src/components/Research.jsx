      ...
      <section className="relative bg-black py-24 overflow-hidden">
        ...
        <div className="max-w-7xl  mx-auto px-4 text-gray-300">
          ...
          <p className="mb-6 text-[#C3C3C3] text-[18px] leading-relaxed">
            ...
            build enduring<br/> relationships. Our success lies in empowering
            professionals who are driven by purpose,<br/> grounded in ethics, and
            committed to making a meaningful difference in clients’ financial<br/>
            lives.<br/>
            <br />
            We are more than a brand — we are a collaborative ecosystem of
            financial experts<br/>, advisors, and entrepreneurs united by one
            mission: To deliver trustworthy, transparent, and<br/> long-term wealth
            solutions that genuinely improve lives.
            <br /><br/>
            Whether you’re a seasoned financial advisor, a tax consultant, an
            insurance specialist, or a<br/> passionate newcomer looking to enter the
            wealth industry — we invite you to grow with us.
            <br /><br/>
            By partnering with Blue Sage Wealth, you gain more than just a
            platform — you gain:
            <br /><br/>
            • The credibility of a trusted brand  <br />
            • The backing of experienced mentors  <br />
            • A full suite of investment, insurance, and planning solutions  
            <br />
            • Ongoing support to help you scale with integrity  <br />
            <br />
